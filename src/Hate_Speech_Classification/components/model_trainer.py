...
from Hate_Speech_Classification.entity.artifact_entity import ModelTrainerArtifacts,DataTransformationArtifacts
from Hate_Speech_Classification.ml.model import ModelArchitecture
