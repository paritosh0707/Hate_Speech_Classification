...
from Hate_Speech_Classification.entity.artifact_entity import ModelEvaluationArtifacts, ModelTrainerArtifacts, DataTransformationArtifacts
...
class ModelEvaluation:
 ...
 data transformation artifact stage
    ...
    def get_best_model_from_cloud(self) -> str:
        """
        ...
        try:
            ...
            self.AwsSync.sync_folder_from_s3(bucket_name = self.model_evaluation_config.BUCKET_NAME,
                                            bucket_folder_name=self.model_evaluation_config.MODEL_NAME,
                                            folder = self.model_evaluation_config.BEST_MODEL_DIR_PATH)
