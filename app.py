from Hate_Speech_Classification.pipeline.train_pipeline import TrainingPipeline
...
from Hate_Speech_Classification.pipeline.prediction_pipeline import PredictionPipeline
